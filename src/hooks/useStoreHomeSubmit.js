...
const useStoreHomeSubmit = () => {
  ...
  const [singleProductPageRightBox, setSingleProductPageRightBox] = useState(true)
  ...
  const [aboutMiddleContentSection, setAboutMiddleContentSection] = useState(true)
  ...
  const [getYourDailyNeedImageLeft, setGetYourDailyNeedImageLeft] = useState('')
  const [getYourDailyNeedImageRight, setGetYourDailyNeedImageRight] = useState('')
  const [textEdit, setTextEdit] = useState(createEditorState(''))
  const [termsConditionsTextEdit, setTermsConditionsTextEdit] = useState(createEditorState(''))
  ...
  const onSubmit = async (data) => {
    ...
    try {
        ...
        setting: {
          ...
          privacy_policy: {
            ...
            description: handleRemoveEmptyKey({
              ...
              [language]: textEdit ? draftToHtml(convertToRaw(textEdit.getCurrentContent())) : '',
            }),
          },
          term_and_condition: {
            ...
            description: {
              ...
              [language]: termsConditionsTextEdit
                ? draftToHtml(convertToRaw(termsConditionsTextEdit.getCurrentContent()))
                : '',
            },
          },
          faq: {
      ...
      if (!isSave) {
        ...
        const res = await SettingServices.addStoreCustomizationSetting(storeCustomizationSettingData)
        // await socket.emit("notification", {
    ...
    const getStoreCustomizationData = async () => {
      try {
        ...
        if (res) {
          ...
          setValue('privacy_policy', res?.navbar?.privacy_policy[language || 'en'])
          setValue('term_and_condition', res?.navbar?.term_and_condition[language || 'en'])
          ...
          const discountCouponCode = res?.home?.discount_coupon_code?.map((coupon) => {
            const newObj = {
              label: coupon,
              value: coupon,
            }
          ...
          setValue('discount_title', res?.home?.discount_title[language || 'en'])
          setValue('promotion_title', res?.home?.promotion_title[language || 'en'])
          setValue('promotion_description', res?.home?.promotion_description[language || 'en'])
          setValue('promotion_button_name', res?.home?.promotion_button_name[language || 'en'])
          setValue('promotion_button_link', res?.home?.promotion_button_link)
          setValue('feature_title', res?.home?.feature_title[language || 'en'])
          setValue('feature_description', res?.home?.feature_description[language || 'en'])
          setValue('feature_product_limit', res?.home?.feature_product_limit)
          setValue('popular_title', res?.home?.popular_title[language || 'en'])
          setValue('popular_description', res?.home?.popular_description[language || 'en'])
          setValue('popular_product_limit', res?.home?.popular_product_limit)
          setValue('quick_delivery_subtitle', res?.home?.quick_delivery_subtitle[language || 'en'])
          setValue('quick_delivery_title', res?.home?.quick_delivery_title[language || 'en'])
          setValue('quick_delivery_description', res?.home?.quick_delivery_description[language || 'en'])
          setValue('quick_delivery_button', res?.home?.quick_delivery_button[language || 'en'])
          setValue('quick_delivery_link', res?.home?.quick_delivery_link)
          setValue('latest_discount_title', res?.home?.latest_discount_title[language || 'en'])
          setValue('latest_discount_description', res?.home?.latest_discount_description[language || 'en'])
          setValue('latest_discount_product_limit', res?.home?.latest_discount_product_limit)
          setValue('daily_need_title', res?.home?.daily_need_title[language || 'en'])
          setValue('daily_need_description', res?.home?.daily_need_description[language || 'en'])
          ...
          setValue('slider_description', res?.slider?.first_description[language || 'en'])
          setValue('slider_button_name', res?.slider?.first_button[language || 'en'])
          setValue('slider_button_link', res?.slider?.first_link)
          setValue('slider_title_two', res?.slider?.second_title[language || 'en'])
          setValue('slider_description_two', res?.slider?.second_description[language || 'en'])
          setValue('slider_button_name_two', res?.slider?.second_button[language || 'en'])
          setValue('slider_button_link_two', res?.slider?.second_link)
          setValue('slider_title_three', res?.slider?.third_title[language || 'en'])
          setValue('slider_description_three', res?.slider?.third_description[language || 'en'])
          setValue('slider_button_name_three', res?.slider?.third_button[language || 'en'])
          setValue('slider_button_link_three', res?.slider?.third_link)
          setValue('slider_title_four', res?.slider?.four_title[language || 'en'])
          setValue('slider_description_four', res?.slider?.four_description[language || 'en'])
          setValue('slider_button_name_four', res?.slider?.four_button[language || 'en'])
          setValue('slider_button_link_four', res?.slider?.four_link)
          setValue('slider_title_five', res?.slider?.five_title[language || 'en'])
          setValue('slider_description_five', res?.slider?.five_description[language || 'en'])
          setValue('slider_button_name_five', res?.slider?.five_button[language || 'en'])
          setValue('slider_button_link_five', res?.slider?.five_link)

          //checkout
          setValue('personal_details', res?.checkout?.personal_details[language || 'en'])
          setValue('first_name', res?.checkout?.first_name[language || 'en'])
          setValue('last_name', res?.checkout?.last_name[language || 'en'])
          setValue('email_address', res?.checkout?.email_address[language || 'en'])
          setValue('checkout_phone', res?.checkout?.checkout_phone[language || 'en'])
          setValue('shipping_details', res?.checkout?.shipping_details[language || 'en'])
          setValue('street_address', res?.checkout?.street_address[language || 'en'])
          ...
          setValue('shipping_cost', res?.checkout?.shipping_cost[language || 'en'])
          setValue('shipping_name_one', res?.checkout?.shipping_name_one[language || 'en'])
          setValue('shipping_one_desc', res?.checkout?.shipping_one_desc[language || 'en'])
          setValue('shipping_one_cost', res?.checkout?.shipping_one_cost)
          setValue('shipping_name_two', res?.checkout?.shipping_name_two[language || 'en'])
          setValue('shipping_two_desc', res?.checkout?.shipping_two_desc[language || 'en'])
          setValue('shipping_two_cost', res?.checkout?.shipping_two_cost)
          setValue('payment_method', res?.checkout?.payment_method[language || 'en'])
          setValue('continue_button', res?.checkout?.continue_button[language || 'en'])
          setValue('confirm_button', res?.checkout?.confirm_button[language || 'en'])
          setValue('order_summary', res?.checkout?.order_summary[language || 'en'])
          setValue('apply_button', res?.checkout?.apply_button[language || 'en'])
          ...
          //dashboard
          setValue('invoice_message_first', res?.dashboard?.invoice_message_first[language || 'en'])
          setValue('invoice_message_last', res?.dashboard?.invoice_message_last[language || 'en'])
          setValue('print_button', res?.dashboard?.print_button[language || 'en'])
          setValue('download_button', res?.dashboard?.download_button[language || 'en'])
          setValue('dashboard_title', res?.dashboard?.dashboard_title[language || 'en'])
          setValue('total_order', res?.dashboard?.total_order[language || 'en'])
          setValue('pending_order', res?.dashboard?.pending_order[language || 'en'])
          setValue('processing_order', res?.dashboard?.processing_order[language || 'en'])
          setValue('complete_order', res?.dashboard?.complete_order[language || 'en'])
          setValue('recent_order', res?.dashboard?.recent_order[language || 'en'])
          setValue('my_order', res?.dashboard?.my_order[language || 'en'])
          setValue('update_profile', res?.dashboard?.update_profile[language || 'en'])
          ...
          setValue('update_button', res?.dashboard?.update_button[language || 'en'])
          setValue('current_password', res?.dashboard?.current_password[language || 'en'])
          setValue('new_password', res?.dashboard?.new_password[language || 'en'])
          setValue('change_password', res?.dashboard?.change_password[language || 'en'])
          ...
          setValue('promo_free_shipping', res?.footer?.shipping_card[language || 'en'])
          setValue('promo_support', res?.footer?.support_card[language || 'en'])
          setValue('promo_payment', res?.footer?.payment_card[language || 'en'])
          setValue('promo_offer', res?.footer?.offer_card[language || 'en'])
          setValue('footer_block_one_title', res?.footer?.block1_title[language || 'en'])
          ...
          setValue('footer_block_one_link_three', res?.footer?.block1_sub_link3)
          setValue('footer_block_one_link_four', res?.footer?.block1_sub_link4)

          setValue('footer_block_one_link_one_title', res?.footer?.block1_sub_title1[language || 'en'])
          setValue('footer_block_one_link_two_title', res?.footer?.block1_sub_title2[language || 'en'])
          setValue('footer_block_one_link_three_title', res?.footer?.block1_sub_title3[language || 'en'])
          setValue('footer_block_one_link_four_title', res?.footer?.block1_sub_title4[language || 'en'])

          setValue('footer_block_two_title', res?.footer?.block2_title[language || 'en'])
          ...
          setValue('footer_block_two_link_three', res?.footer?.block2_sub_link3)
          setValue('footer_block_two_link_four', res?.footer?.block2_sub_link4)

          setValue('footer_block_two_link_one_title', res?.footer?.block2_sub_title1[language || 'en'])
          setValue('footer_block_two_link_two_title', res?.footer?.block2_sub_title2[language || 'en'])
          setValue('footer_block_two_link_three_title', res?.footer?.block2_sub_title3[language || 'en'])
          setValue('footer_block_two_link_four_title', res?.footer?.block2_sub_title4[language || 'en'])

          setValue('footer_block_three_title', res?.footer?.block3_title[language || 'en'])
          setValue('footer_block_three_link_one', res?.footer?.block3_sub_link1)
          setValue('footer_block_three_link_two', res?.footer?.block3_sub_link2)
          setValue('footer_block_three_link_three', res?.footer?.block3_sub_link3)
          setValue('footer_block_three_link_four', res?.footer?.block3_sub_link4)

          setValue('footer_block_three_link_one_title', res?.footer?.block3_sub_title1[language || 'en'])
          setValue('footer_block_three_link_two_title', res?.footer?.block3_sub_title2[language || 'en'])
          setValue('footer_block_three_link_three_title', res?.footer?.block3_sub_title3[language || 'en'])
          setValue('footer_block_three_link_four_title', res?.footer?.block3_sub_title4[language || 'en'])

          setValue('footer_block_four_address', res?.footer?.block4_address[language || 'en'])
          ...
          setValue('slug_page_card_icon_one', res?.slug?.slug_page_card_icon_one)
          setValue('slug_page_card_description_one', res?.slug?.card_description_one[language || 'en'])

          setValue('slug_page_card_icon_two', res?.slug?.slug_page_card_icon_two)
          setValue('slug_page_card_description_two', res?.slug?.card_description_two[language || 'en'])

          setValue('slug_page_card_icon_three', res?.slug?.slug_page_card_icon_three)
          setValue('slug_page_card_description_three', res?.slug?.card_description_three[language || 'en'])

          setValue('slug_page_card_icon_four', res?.slug?.slug_page_card_icon_four)
          setValue('slug_page_card_description_four', res?.slug?.card_description_four[language || 'en'])

          setValue('slug_page_card_icon_five', res?.slug?.slug_page_card_icon_five)
          setValue('slug_page_card_description_five', res?.slug?.card_description_five[language || 'en'])

          setValue('slug_page_card_icon_six', res?.slug?.slug_page_card_icon_six)
          setValue('slug_page_card_description_six', res?.slug?.card_description_six[language || 'en'])

          setValue('slug_page_card_icon_seven', res?.slug?.slug_page_card_icon_seven)
          setValue('slug_page_card_description_seven', res?.slug?.card_description_seven[language || 'en'])
          ...
          setValue('about_page_Top_title', res?.about_us?.top_title[language || 'en'])
          setValue('about_us_top_description', res?.about_us?.top_description[language || 'en'])
          setValue('about_page_Top_left_box_one_title', res?.about_us?.card_one_title[language || 'en'])
          setValue('about_page_Top_left_box_one_subtitle', res?.about_us?.card_one_sub[language || 'en'])
          setValue('about_us_top_box_one_description', res?.about_us?.card_one_description[language || 'en'])
          setValue('about_page_Top_left_box_two_title', res?.about_us?.card_two_title[language || 'en'])
          setValue('about_page_Top_left_box_two_subtitle', res?.about_us?.card_two_sub[language || 'en'])
          setValue('about_us_top_box_two_description', res?.about_us?.card_two_description[language || 'en'])
          setValue('about_us_middle_description_one', res?.about_us?.middle_description_one[language || 'en'])
          setValue('about_us_middle_description_two', res?.about_us?.middle_description_two[language || 'en'])
          setValue('about_page_ourfounder_title', res?.about_us?.founder_title[language || 'en'])
          setValue('about_us_ourfounder_description', res?.about_us?.founder_description[language || 'en'])
          setValue('about_page_ourfounder_one_title', res?.about_us?.founder_one_name[language || 'en'])
          setValue('about_page_ourfounder_one_sub_title', res?.about_us?.founder_one_sub[language || 'en'])
          setValue('about_page_ourfounder_two_title', res?.about_us?.founder_two_name[language || 'en'])
          setValue('about_page_ourfounder_two_sub_title', res?.about_us?.founder_two_sub[language || 'en'])
          setValue('about_page_ourfounder_three_title', res?.about_us?.founder_three_name[language || 'en'])
          setValue('about_page_ourfounder_three_sub_title', res?.about_us?.founder_three_sub[language || 'en'])
          setValue('about_page_ourfounder_four_title', res?.about_us?.founder_four_name[language || 'en'])
          setValue('about_page_ourfounder_four_sub_title', res?.about_us?.founder_four_sub[language || 'en'])
          setValue('about_page_ourfounder_five_title', res?.about_us?.founder_five_name[language || 'en'])
          setValue('about_page_ourfounder_five_sub_title', res?.about_us?.founder_five_sub[language || 'en'])
          setValue('about_page_ourfounder_six_title', res?.about_us?.founder_six_name[language || 'en'])
          setValue('about_page_ourfounder_six_sub_title', res?.about_us?.founder_six_sub[language || 'en'])
          ...
          setValue('contact_page_title', res?.contact_us?.title[language || 'en'])
          setValue('email_box_title', res?.contact_us?.email_box_title[language || 'en'])
          setValue('email_box_email', res?.contact_us?.email_box_email[language || 'en'])
          setValue('email_box_text', res?.contact_us?.email_box_text[language || 'en'])
          setValue('callUs_box_title', res?.contact_us?.call_box_title[language || 'en'])
          setValue('callUs_box_phone', res?.contact_us?.call_box_phone[language || 'en'])
          setValue('callUs_box_text', res?.contact_us?.call_box_text[language || 'en'])
          setValue('address_box_title', res?.contact_us?.address_box_title[language || 'en'])
          setValue('address_box_address_one', res?.contact_us?.address_box_address_one[language || 'en'])
          setValue('address_box_address_two', res?.contact_us?.address_box_address_two[language || 'en'])
          setValue('address_box_address_three', res?.contact_us?.address_box_address_three[language || 'en'])
          setValue('contact_form_title', res?.contact_us?.form_title[language || 'en'])
          setValue('contact_form_description', res?.contact_us?.form_description[language || 'en'])

          //privacy policy
          setPrivacyPolicy(res?.privacy_policy?.status)
          setPrivacyPolicyHeaderBg(res?.privacy_policy?.header_bg)
          setValue('privacy_page_title', res?.privacy_policy?.title[language || 'en'])

          setTextEdit(createEditorState(showingTranslateValue(res?.privacy_policy?.description)))

          //term and condition
          setTermsConditions(res?.term_and_condition?.status)
          setTermsConditionsHeaderBg(res?.term_and_condition?.header_bg)
          setValue('termsConditions_page_title', res?.term_and_condition?.title[language || 'en'])

          setTermsConditionsTextEdit(createEditorState(showingTranslateValue(res?.term_and_condition?.description)))
          ...
          setValue('faq_description_one', res?.faq?.description_one[language || 'en'])
          setValue('faq_title_two', res?.faq?.faq_two[language || 'en'])
          setValue('faq_description_two', res?.faq?.description_two[language || 'en'])
          setValue('faq_title_three', res?.faq?.faq_three[language || 'en'])
          setValue('faq_description_three', res?.faq?.description_three[language || 'en'])
          setValue('faq_title_four', res?.faq?.faq_four[language || 'en'])
          setValue('faq_description_four', res?.faq?.description_four[language || 'en'])
          setValue('faq_title_five', res?.faq?.faq_five[language || 'en'])
          setValue('faq_description_five', res?.faq?.description_five[language || 'en'])
          setValue('faq_title_six', res?.faq?.faq_six[language || 'en'])
          setValue('faq_description_six', res?.faq?.description_six[language || 'en'])
          setValue('faq_title_seven', res?.faq?.faq_seven[language || 'en'])
          setValue('faq_description_seven', res?.faq?.description_seven[language || 'en'])
          setValue('faq_title_eight', res?.faq?.faq_eight[language || 'en'])
          setValue('faq_description_eight', res?.faq?.description_eight[language || 'en'])
