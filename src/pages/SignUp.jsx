          ...
          <main className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div className="w-full">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <LabelArea label={t('loginScreen.createAccount.emailLbl')} />
                <InputArea
                  required={true}
                  register={register}
                  label="Email"
                ...
                <LabelArea label={t('loginScreen.createAccount.passwordLbl')} />
                <InputArea
                  required={true}
                  register={register}
                  label="Password"
                ...
                <Label className="mt-6" check>
                  <Input type="checkbox" />
                  <span className="ml-2">
                    {t('loginScreen.createAccount.iAgree')}{' '}
                    <span className="underline">{t('loginScreen.createAccount.privacyPolicy')}</span>
                  </span>
                </Label>
              ...
              >
                ...
                <span className="ml-2"> {t('loginScreen.createAccount.signupWithFacebook')} </span>
              </button>
              <button
                disabled
              ...
              >
                ...
                <span className="ml-2">{t('loginScreen.createAccount.signupWithGoogle')}</span>
              </button>
              ...
              <p className="mt-4">
                <Link
                  ...
                  to="/login"
                >
                  {t('loginScreen.createAccount.alreadyHaveAccount')}
                </Link>
              </p>
            </div>
          </main>
