            ...
            <main className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
              <div className="w-full">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  <LabelArea label={t('loginScreen.emailLbl')} />
                  <InputArea
                    required={true}
                    register={register}
                  ...
                  <LabelArea label={t('loginScreen.passwordLbl')} />
                  <InputArea
                    required={true}
                    register={register}
                  ...
                  >
                    ...
                    <span className="ml-2"> {t('loginScreen.loginWithFacebook')} </span>
                  </button>
                  <button
                    disabled
                  ...
                  >
                    ...
                    <span className="ml-2">{t('loginScreen.loginWithGoogle')}</span>
                  </button>
                </form>
