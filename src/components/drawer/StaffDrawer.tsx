...
import { Card, CardBody, WindmillContext, Input as WindmillInput } from '@windmill/react-ui'
...
const StaffDrawer: React.FC<StaffDrawerProps> = ({ id }) => {
  ...
  useEffect(() => {
    if (id && adminInfo?.role) {
      setSelectedRole(adminInfo.role.id || adminInfo.role)
    }
  }, [id, adminInfo])
                ...
                <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  ...
                  <div className="col-span-8 sm:col-span-4">
                    <InputArea
                      ...
                      placeholder={String(t('staffScreen.drawer.inputName'))}
                    />
                ...
                <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  ...
                  <div className="col-span-8 sm:col-span-4">
                    <InputArea
                      ...
                      placeholder={String(t('staffScreen.drawer.inputEmail'))}
                    />
                ...
                <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  ...
                  <div className="col-span-8 sm:col-span-4">
                    <InputArea
                      ...
                      placeholder={String(t('staffScreen.drawer.inputPassword'))}
                    />
                ...
                <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  ...
                  <div className="col-span-8 sm:col-span-4">
                    <InputArea
                      ...
                      maxLength={15}
                      type="text"
                      placeholder={String(t('staffScreen.drawer.inputContact'))}
                    />
