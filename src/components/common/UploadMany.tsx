      ...
      <div className="flex">
        <div ref={dRef} className="lg:flex-1 md:flex-1 mr-3 sm:flex-none">
          {(title === 'Products' ||
            ...
            >
              ...
              <span className="text-xs">{t('common.export.label')}</span>
            </button>
          )}
          {dropDown && (
            <ul
            ...
            >
              <li className="justify-between font-serif font-medium py-2 pl-4 transition-colors duration-150 hover:bg-gray-100 text-gray-500 hover:text-emerald-500 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200">
                <button type="button" onClick={handleExportCSV} className="focus:outline-none">
                  <span className="flex items-center text-sm">
                    <BsFileEarmarkMedical className="w-4 h-4 mr-3" aria-hidden="true" />

                    <span>
                      {t('common.export.toCSV')}
              ...
              <li className="justify-between font-serif font-medium py-2 pl-4 transition-colors duration-150 hover:bg-gray-100 text-gray-500 hover:text-emerald-500 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200">
                <button type="button" className="focus:outline-none" onClick={handleExportJSON}>
                  <span className="flex items-center text-sm">
                    <BsFileEarmarkCode className="w-4 h-4 mr-3" aria-hidden="true" />
                    <span>
                      {t('common.export.toJSON')}
        ...
        <div className="lg:flex-1 md:flex-1 mr-3  sm:flex-none">
          ...
          >
            ...
            <span className="text-xs">{t('common.import.label')}</span>
          </button>
        </div>
      </div>
          ...
          <div className="w-full my-2 lg:my-0 md:my-0 flex">
            ...
            <div className="flex">
              {loading ? (
                ...
                <Button onClick={handleUploadMultiple} className="h-10 ml-2 px-2">
                  <span className="">
                    <FiPlus />
                  </span>

                  <span className="text-sx w-20">{t('common.import.now')}</span>
                </Button>
              )}
            </div>
          </div>
