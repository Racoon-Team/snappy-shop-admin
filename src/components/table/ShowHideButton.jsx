  ...
  const handleChangeStatus = async (id) => {
    ...
    try {
      ...
      if (location.pathname === '/categories' || category) {
        ...
        setIsUpdate(true)
        const messageKey =
          res.messageKey === 'show' ? 'categoriesScreen.message.published' : 'categoriesScreen.message.unpublished'
      ...
      if (location.pathname === '/products') {
        ...
        setIsUpdate(true)
        const messageKey =
          res.messageKey === 'show' ? 'productsScreen.message.statusShow' : 'productsScreen.message.statusHide'
        const message = t(messageKey)
        notifySuccess(message)
      }
      ...
      if (location.pathname === '/languages') {
        ...
        setIsUpdate(true)
        const messageKey =
          res.messageKey === 'show' ? 'languagesScreen.message.published' : 'languagesScreen.message.unPublished'
        const message = t(messageKey)
        notifySuccess(message)
      }
      if (location.pathname === '/currencies') {
        if (currencyStatusName === 'status') {
          ...
          setIsUpdate(true)
          const messageKey =
            res.messageKey === 'show' ? 'currenciesScreen.message.published' : 'currenciesScreen.message.unpublished'
          const message = t(messageKey)
          notifySuccess(message)
        } else {
      ...
      if (location.pathname === '/attributes') {
        ...
        setIsUpdate(true)
        const messageKey =
          res.messageKey === 'show' ? 'attributesScreen.message.published' : 'attributesScreen.message.unpublished'
        const message = t(messageKey)
        notifySuccess(message)
      }
      ...
      if (location.pathname === '/coupons') {
        ...
        setIsUpdate(true)
        const messageKey =
          res.messageKey === 'show' ? 'couponsScreen.message.published' : 'couponsScreen.message.unpublished'
        const message = t(messageKey)
        notifySuccess(message)
      }
