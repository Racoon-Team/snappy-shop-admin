...
const SeoSetting = ({ errors, register, isSave, favicon, setFavicon, metaImg, setMetaImg, isSubmitting }) => {
      ...
      <div className="grid grid-cols-12 font-sans">
        <div className="col-span-12 md:col-span-12 lg:col-span-12 mr-3 ">
          <div className="inline-flex md:text-lg text-base text-gray-800 font-semibold dark:text-gray-400 mb-3 relative">
            ...
            {t('storeCustomizationScreen.soeSetting.title')}
          </div>
          ...
          <div className="lg:px-6 pt-4 lg:pl-40 lg:pr-40 md:pl-5 md:pr-5 flex-grow scrollbar-hide w-full max-h-full pb-0">
            <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
              <label className="block text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1 sm:col-span-2">
                {t('storeCustomizationScreen.soeSetting.favicon')}
              </label>
            ...
            <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
              <label className="block text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1 sm:col-span-2">
                {t('storeCustomizationScreen.soeSetting.metaTitle')}
              </label>
              <div className="sm:col-span-3">
                <InputAreaTwo
                  register={register}
                  ...
                  name="meta_title"
                  type="text"
                  placeholder={t('storeCustomizationScreen.soeSetting.metaTitle')}
                />
            ...
            <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
              <label className="block text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1 sm:col-span-2">
                {t('storeCustomizationScreen.soeSetting.metaDescription')}
              </label>
              <div className="sm:col-span-3">
                <TextAreaCom
                  required={true}
                  ...
                  type="text"
                  placeholder={t('storeCustomizationScreen.soeSetting.metaDescription')}
                />
            ...
            <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
              <label className="block text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1 sm:col-span-2">
                {t('storeCustomizationScreen.soeSetting.metaUrl')}
              </label>
              <div className="sm:col-span-3">
                <InputAreaTwo
                  register={register}
                  ...
                  name="meta_url"
                  type="text"
                  placeholder={t('storeCustomizationScreen.soeSetting.metaUrl')}
                />
            ...
            <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
              <label className="block text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1 sm:col-span-2">
                {t('storeCustomizationScreen.soeSetting.metaKeyword')}
              </label>
              <div className="sm:col-span-3">
                <TextAreaCom
                  register={register}
                  ...
                  name="meta_keywords"
                  type="text"
                  placeholder={t('storeCustomizationScreen.soeSetting.metaKeyword')}
                />
            ...
            <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
              <label className="block text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1 sm:col-span-2">
                {t('storeCustomizationScreen.soeSetting.metaImage')}
              </label>
              <div className="sm:col-span-3">
