          ...
          <TableRow key={i + 1}>
                ...
                {variant.image ? (
                  <span>
                    <Avatar
                      ...
                      alt="product"
                    />
                    <p className="text-xs cursor-pointer" onClick={() => handleSelectInlineImage(i)}>
                      {t('Change')}
                    </p>
                  </span>
                ) : (
            ...
            <TableCell>
              <div className="flex flex-col text-sm">
                ...
                {variant.productId && <span className="text-xs productId text-gray-500">({variant.productId})</span>}
              </div>
            </TableCell>
