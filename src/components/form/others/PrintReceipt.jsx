    ...
    <>
      <div style={{ display: 'none' }}>
        {Object.keys(orderData).length > 0 && (
          <InvoiceForPrint data={orderData} printRef={printRefTwo} globalSetting={globalSetting} />
        )}
      </div>
      <button
      ...
      >
        <Tooltip id="receipt" Icon={FiPrinter} title={t('ordersScreen.table.printReceipt')} bgColor="#f59e0b" />
      </button>
    </>
  )
}
