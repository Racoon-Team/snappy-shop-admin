...
const routeAccessList = [
  ...
  { label: 'Products', value: ['products', 'product'] },
  { label: 'Categories', value: 'categories' },
  { label: 'Attributes', value: 'attributes' },
  { label: 'Coupons', value: 'coupons' },
  { label: 'Customers', value: 'customers' },
  { label: 'Customer Order', value: 'customer-order' },
  { label: 'Orders', value: ['orders', 'order'] },
  { label: 'Staff', value: 'our-staff' },
  { label: 'Settings', value: 'settings' },
  { label: 'Languages', value: 'languages' },
  { label: 'Currencies', value: 'currencies' },
  { label: 'ViewStore', value: 'store' },
  { label: 'StoreCustomization', value: ['customization', 'store'] },
  { label: 'StoreSettings', value: ['store-settings', 'store'] },
  { label: 'Delivery Points', value: ['delivery-points', 'store'] },
  { label: 'Edit Profile', value: 'edit-profile' },
  { label: 'Role Settings', value: 'roles' },
