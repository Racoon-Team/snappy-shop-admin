      ...
      <Card className="min-w-0 shadow-xs overflow-hidden bg-white dark:bg-gray-800 dark:text-gray-400 mb-5">
        <CardBody>
          <div className="grid grid-cols-3 md:grid-cols-6 lg:grid-cols-7">
            ...
            <Link to="/localization/languages" className="mx-3 font-medium font-serif">
              {t('Languages')}
            </Link>
            <Link to="/localization/currencies" className="mx-3 font-medium font-serif">
              {t('Currencies')}
            </Link>
            <Link to="/localization/geolocation" className="mx-3 font-medium font-serif">
              {t('Geolocation')}
            </Link>
