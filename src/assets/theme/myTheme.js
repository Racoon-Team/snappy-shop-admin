const myTheme = {
  ...
  alert: {
    ...
    withClose: 'pr-12',
    success: 'bg-emerald-50 text-emerald-900 dark:bg-emerald-600 dark:text-white',
  ...
  textarea: {
    ...
    valid: 'border-emerald-600 dark:bg-gray-700 focus:border-emerald-400 dark:focus:border-emerald-400',
  ...
  input: {
    ...
    valid: 'border-emerald-600 dark:bg-gray-700 focus:border-emerald-400 dark:focus:border-emerald-400',
    invalid: 'border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400',
    radio: 'text-emerald-600 form-radio focus:border-emerald-400 focus:outline-none',
    checkbox: 'text-emerald-600 form-checkbox focus:border-emerald-500 focus:outline-none rounded',
  },
  // HelperText
  helperText: {
    base: 'text-xs',
